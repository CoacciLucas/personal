    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex gap-2 px-4 py-3 border-t border-gray-200">
        ...
        <button
          ...
          className="px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-300 text-white rounded-xl transition-colors text-sm"
        >
          Enviar
        </button>
      </div>
